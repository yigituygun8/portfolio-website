...
const About = () => {
  return (
    <section id="about" className='w-full px-[12%] py-10 font-jetbrains'>
        ...
        <div className='flex w-full flex-col md:flex-row items-center md:items-start justify-center gap-25 my-20'>
            ...
            <div>
                ...
                <h4 className='my-6 text-gray-700 font-semibold'>Tools & Frameworks:</h4>
                <ul className='flex items-center gap-3 sm:gap-5'>
                    {toolsData.map((tool, index) => {
                        return (
                            <li key={index} className='flex items-center justify-center p-2 w-14 border border-gray-400 rounded-lg hover:-translate-y-1 duration-300 cursor-pointer'>
                                <Image src={tool} alt='Tool' className='w-5 h-5 object-contain sm:w-7 sm:h-7'></Image>
                            </li>
                        );
                    })}
                </ul>
